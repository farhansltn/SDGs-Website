...
<head>
    ...
    <title>Admin-PublikasiTestimoni</title>
      ...
      <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header" style="height: auto;">
              <h1>
                  Testimoni
                  <small>User/Admin Website</small>
                </h1>
                        ...
                        <!--------------------------
                          ...
                          <div class="box box-primary" style="padding : 20px;border-color: #f39d12;height: 140px;">
                           <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini 
                              ...
                              <a href="Admin-AturTestimoni.php" style="font-size: larger; background-color: #ffb744;" class="btn btn-sm btn-info btn-flat pull-left">Buat Testimoni</a>
                           </div>
                          <div class="box">
                              <div class="box-header">
                                <h3>Daftar Testimoni Admin/Website</h3>
                              </div> 
                              <div class="box-body table-responsive">
                                  ...
                                  <thead style="background-color: #f39d12;color: #ffffff;">
                                    <tr>
                                      ...
                                      <th>Nomor Telpon Pengguna</th>
                                      <th>Sektor Penilaian Pengguna</th>
                                        <th>Saran/Testimoni Pengguna</th>
                                      <th>Review Pengguna</th>
                                      <th>Hapus Testimoni</th>
                                    </tr>
                                  </thead>
                                  <tbody style="text-align: center;">
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo substr($row['editor1'],0,100); ?></td>
                                          <td><a href="deletetestimoni.php?id=<?= $row["id"]; ?>" onclick="return confirm('Hapus Data?');"><button type="submit" class="btn btn-primary" style="background-color:red">Delete</button></a></td>
