...
<head>
  ...
  <title>Admin-Publikasi Video</title>
      ...
      <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header" style="height: auto;">
              <h1>
                  Publikasi
                  <small>Video Website</small>
                </h1>     <section class="content container-fluid" >
                        <!--------------------------
                          ...
                          <div class="box box-primary" style="padding : 20px;border-color: #f39d12;height: 140px;">
                           <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini 
                              ...
                              <a href="Admin-AturVideo.php" style="font-size: larger; background-color: #ffb744;" class="btn btn-sm btn-info btn-flat pull-left">Update Dokumen</a>
                           </div>
                          <div class="box">
                              <div class="box-header">
                                <h3>Daftar Publikasi Video</h3>
                              </div> 
                              <!-- /.box-header -->
                          ...
                          <td><a href="deletevideo.php?id=<?= $row["id"]; ?>" onclick="return confirm('Hapus link?');"><button type="submit" class="btn btn-primary" style="background-color:red">Delete</button></a></td>
