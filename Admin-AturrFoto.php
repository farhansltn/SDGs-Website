...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header" style="height: auto;">
        <h1>
            Daftar
            <small>Foto Gallery</small>
          </h1>
          <section style="padding: 60px;">  
            <div class="box box-primary" style="border-color:#f39d12;">
              <div class="box-header with-border">
                <form action="ScriptFileUploadimg.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="name_input">Nama Pengupload</label>
                        <input type="text" class="form-control" id="name_input" name="nama" placeholder="Name">
                    </div>
                    <div class="form-group">
                        <label for="title">Judul Foto</label>
                        <textarea class="form-control" id="title_file" name="namafoto" rows="2" maxlength="50"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="namadepan">Tanggal Upload</label>
                    ...
                    <div class="form-group">
                        <label for="title">Caption Foto</label>
                        <textarea class="form-control" id="title_file" name="caption" rows="3" maxlength="150"></textarea>
                    </div>
                    <div class="form-group">
                        <p>Maksimal Ukuran foto < 2mb </p>
                        <label for="file_upload">Upload File</label>
                        <input type="file" name="berkas" id = "image" accept=".jpg, .jpeg, .png" onchange="readURL(this);" style="margin-bottom:60px;" >
                        
                        <label for="file_upload">Preview File</label>
                        <img id="blah" src="image/400x400.jpg" alt="your image" /> 
                    </div>
                    <button type="submit" class="btn btn-primary" style="background-color:#f39d12;">Submit</button>
          </form>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Hak Cipta &copy; 2023 <a href="#" style="color:#f39d12;">Bappeda DKI Jakarta</a>.</strong> All rights reserved.
  </footer>
