...
<head>
  ...
  <title>Admin-PublikasiFoto</title>
                      ...
                      <section class="content container-fluid">
                        <!--------------------------
                          ...
                          <div class="box">
                              ...
                              <a href="Admin-Aturrfoto.php" style="font-size: larger; background-color: #ffb744;" class="btn btn-sm btn-info btn-flat pull-left">Update Dokumen</a>
                           </div> 
                              <!-- /.box-header -->
                          ...
                          <td><a href="delete.php?id=<?= $row["id"]; ?>" onclick="return confirm('Hapus Data?');"><button type="submit" class="btn btn-primary" style="background-color:red">Delete</button></a></td>
									<?php 
											}
										} 
									?>
