...
<head>
  ...
  <title>Admin-DaftarDokumen</title>
      ...
      <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header" style="height: auto;">
              <h1>
                ...
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                            <!-- Optionally, you can add icons to the links -->
                           <h3><a href="">Input Dokumen TPB</a></h3>
                           <form action="ScriptFileDokumen.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="email_addr">Judul Dokumen</label>
                <input type="text" class="form-control" id="judul" name="judul" placeholder="sdgs@gmail.com">
            </div>
            <div class="form-group">
                <label for="name_input">Tentang</label>
                <input type="text" class="form-control" id="name_input" name="tentang" placeholder="Name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="name_input">LinkFile</label>
                <input type="text" class="form-control" id="name_input" name="link2" placeholder="Name">
            </div>
