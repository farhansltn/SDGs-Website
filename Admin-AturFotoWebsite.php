...
<html>
  <head>
    ...
    <title>Admin-DaftarPublikasiFoto</title>
              ...
              <h1>
                ...
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                            <!-- Optionally, you can add icons to the links -->
                           <h3><a href="">Upload Publikasi Foto</a></h3>
                          <form action="ScriptFileUploadimgWeb.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="title_file" name="judulfoto" rows="3"></textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="file" name="berkas" id = "image" accept=".jpg, .jpeg, .png" value="">  </div>
