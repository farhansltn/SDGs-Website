...
<head>
  ...
  <title>Admin-HomePengguna</title>
                  ...
                  <div class="box box-primary" style="padding: 20px;border-color: #f39d12;">
                      <section class="content container-fluid">
                        <!--------------------------
                          ...
                          -------------------------->
                          <div class="box box-primary" style="padding: 20px;border-color: #f39d12;height:350px;">
                          <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini 
                              ...
                              menu kontak di <a href="">website SDG's Jakarta</a>, Terima Kasih.</p>
                               <ul class="sidebar-menu" data-widget="tree">
                                <li class="header" style="background-color: #f39d1223;"><h4>Update Informasi TPB</h4></li>
                                <!-- Optionally, you can add icons to the links -->
                                <li><a href="homepage.php"><i class="fa fa-link"></i> <span>Daftar Pengguna</span></a></li>
                                <li><a href="Admin-PublikasiDaftarStakeholders.php"><i class="fa fa-link"></i> <span>Daftar Stakeholder</span></a></li>
                                <li><a href="Admin-PublikasiKontak.php"><i class="fa fa-link"></i> <span>Daftar Kontak</span></a></li>
                            </ul>
                        </div>
                      </section>
                  </div>
