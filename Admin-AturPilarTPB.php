...
<head>
  ...
  <title>Admin-AturPilarTPB</title>
              ...
              <h1>
                ...
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                            <!-- Optionally, you can add icons to the links -->
                           <h3><a href="">Input Informasi Pillar TPB</a></h3>
                          <form action="ScriptFileUploadPilarTPB.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
                          <div class="form-group">
                              <label for="name_input">Nama Pilar</label>
                            ...
                            <div class="box box-info">
                              <div class="box-header">
                                <h3 class="box-title">Indikator
                                  <small>Indikator Pillar TPB</small>
                                </h3>
                                <!-- tools box -->
