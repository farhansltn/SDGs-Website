...
<head>
  ...
  <title>Admin-LaporanBulanan</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
              ...
              <h1>
                ...
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                           ...
                           <form action="ScriptFileUpload2.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <textarea class="form-control" id="title_file" name="namabuku" rows="3" maxlength="100"></textarea>
          </div>
          <div class="form-group">
