...
<head>
  ...
  <title>Admin-LaporanLainnya</title>
  ...
  <header class="main-header" >
    ...
    <div class="content-wrapper">
              ...
              <h1>
                ...
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                            <!-- Optionally, you can add icons to the links -->
                           <h3><a href="">Laporan Seperti VLR dan sebagainya</a></h3>
                           <form action="ScriptFileUploadLaporanLainnya.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" id="name_input" name="nama" placeholder="NAMA PANJANG">
          </div>
          <div class="form-group">
              <label for="title">Judul</label>
              <textarea class="form-control" id="title_file" name="namabuku" rows="1"></textarea>
          </div>
          <div class="form-group">
            <label for="name_input">Penjelasan Singkat</label>
            <textarea class="form-control" id="title_file" name="penjelasan" rows="2" maxlength="100"></textarea>
          </div>
          <div class="form-group">
            <label for="name_input">Bulan Terbit</label>
            <input type="text" class="form-control" id="month" name="bulan">
          <div class="form-group">
