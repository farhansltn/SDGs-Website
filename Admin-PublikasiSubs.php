...
<head>
  ...
  <title>Admin-PublikasiSubscriber</title>
                        ...
                        <!--------------------------
                          ...
                          <div class="box box-primary" style="padding : 20px;border-color: #f39d12;height: 140px;">
                           <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini 
                              ...
                              <a href="Admin-AturSubscriber.php" style="font-size: larger; background-color: #ffb744;" class="btn btn-sm btn-info btn-flat pull-left">Update Dokumen</a>
                           </div>
                          <div class="box">
                  ...
                  <div class="box box-primary"style="border-color: #f39c12;">
                      <section class="content container-fluid">
                        <!--------------------------
                              ...
                              <div class="box-body table-responsive">
                                  ...
                                  <thead style="background-color: #f39d12;color: #ffffff;">
                                          <tr>
                                            ...
                                            <th>E-Mail Subscriber</th>
                                            <th>Ip Subscriber</th>
                                            <th>Peran Subscriber</th>
                          ...
                          <td><a href="deletesubs.php?id=<?= $row["id"]; ?>" onclick="return confirm('Hapus Data?');"><button type="submit" class="btn btn-primary" style="background-color:red">Delete</button></a></td>
												</tr>
									<?php 
											}
										} 
