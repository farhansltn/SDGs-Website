              ...
              <h1>
                ...
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                            <!-- Optionally, you can add icons to the links -->
                           <h3><a href="">Kontak TPB,Stakeholders, dan lainnya.</a></h3>
                          <form action="ScriptFileUploadKontak.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              <label for="name_input">Nama User</label>
                          ...
                          <div class="form-group">
                            <label for="jenkel">Peran User</label>
                            <select class="form-control select2" data-placeholder="Pilih Peran" name="peran">
                              <option value="Admin">Manager Pillar</option>
                              <option value="User">Aparatur Sipil Negara</option>
                              <option value="Normal">Tenaga Ahli</option>
