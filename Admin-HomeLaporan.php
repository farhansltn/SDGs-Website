      ...
      <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header">
              <h1>
                  Home
                  <small>Laporan Tujuan Pembangunan Berkelanjutan</small>
                </h1>
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39d12;height:430px;">
                    <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini 
                           ...
                           <ul class="sidebar-menu" data-widget="tree">
                            <li class="header" style="background-color: #f39d1223;"><h4>Upload Laporanmu!</h4></li>
                            <!-- Optionally, you can add icons to the links -->
                            <li><a href="Admin-LaporanHarian.php"><i class="fa fa-link"></i> <span>Laporan Harian</span></a></li>
                            <li><a href="Admin-LaporanBulanan.php"><i class="fa fa-link"></i> <span>Laporan Bulanan</span></a></li>
                            <li><a href="Admin-LaporanTahunan.php"><i class="fa fa-link"></i> <span>Laporan Tahunan</span></a></li>
                            <li><a href="Admin-LaporanLainnya.php"><i class="fa fa-link"></i> <span>Laporan Lainnya</span></a></li>
                          </ul>
                    </div>
              </section>
