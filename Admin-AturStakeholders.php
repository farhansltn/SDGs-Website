...
<head>
  ...
  <title>Admin-DaftarStakeholder</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header" style="height: auto;">
        <h1>
            Daftar
            <small>Daftar Stakeholder</small>
          </h1>
          <section style="padding: 10px;">  
            <div class="box box-primary" style="border-color: #f39c12">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action="ScriptFileUpload4.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
                <div class="box-body">
                  <div class="form-group">
                        <div class="row">
                          <div class="col-xs-4">
                            <label for="biper">Pilih Bidang Perusahaan</label>
                            <select class="form-control select2" data-placeholder="Pilih Bidang Perusahaan" name="biper">
                          ...
                          <div class="col-xs-6">
                            <label for="namadepan">Nama Perusahaan</label>
                            <input type="text" class="form-control" placeholder="BELAKANG" name="namaperusahaan">
                          </div>
                        </div>
                  </div>
                  <div class="form-group" style="width: 82.8%;">
                    <label for="jenper">Jenis Perusahaan</label>
                    <select class="form-control select2" data-placeholder="Pilih Jenis Peursahaan" name="jenisperusahaan">
                      <option value="PT">PT</option>
                      <option value="Non-PT">Non PT</option>
                    </select></div>
                    <div class="form-group" style="width: 82.8%;">
                        <label for="jenislaba">Keuntungan</label>
                        <select class="form-control select2" data-placeholder="Pilih Jenis Kelamin" name="jenislaba">
                          <option value="Profit">Profit</option>
                          <option value="Non-Profit">Non Profit</option>
                        </select>
                    </div>
                    <div class="form-group" style="width: 82.8%;">
                        <label for="profit">Keuntungan (Jika Profit)</label>
                        <select class="form-control select2" data-placeholder="" name="profit">
                          <option value="Profit">Rp. 0</option>
                          <option value="0 - 1.000.000">Rp.(0 - 1.000.000)</option>
                          <option value="1.000.000 - 15.000.000">Rp.(1.000.000 - 15.000.000)</option>
                          <option value="15.000.000 - 50.000.000">Rp.(15.000.000 - 50.000.000)</option>
                          <option value="50.000.000 - 100.000.000">Rp.(50.000.000 - 100.000.000)</option>
                          <option value="100.000.000 - 500.000.000">Rp.(100.000.000 - 500.000.000)</option>
                          <option value=">Rp.500.000.000">>Rp.500.000.000</option>
                        </select>
                    </div>
                  <div class="form-group"  style="width: 82.8%;">
                    <label for="jenkel">Jumlah Karyawan</label>
                    <select class="form-control select2" data-placeholder="Pilih Jenis Kelamin" name="jumkar">
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-xs-5">
                        <label for="namadepan">Tempat</label>
                        <input type="text" class="form-control" placeholder="Jakarta" name="tempat">
                      </div>
                      <div class="col-xs-5">
                        <label for="namadepan">Tanggal Berdiri</label>
                  ...
                  <div class="form-group" style="width: 82.8%;">
                        <label for="namadepan">Peran yang diinginkan</label>
                        <input type="text" class="form-control" placeholder="" name="peran">
                    </div>
                    <div class="form-group" style="width: 82.8%;">
                        <div class="row">
                            <div class="col-xs-5">
                                <label>Nomor Telpon Perusahan</label>
                                <div class="input-group">
                                  <div class="input-group-addon">
                                    <i class="fa fa-phone"></i>
                                  </div>
                                  <input type="text" class="form-control" data-inputmask='"mask": "(+62) 9999-9999-9999"' data-mask name="notelpon">
                                </div>
                            </div>
                            <div class="col-xs-5">
                              <label for="namadepan">Nomor Fax-Perusahaan</label>
                              <div class="input-group">
                                <div class="input-group-addon">
                                  <i class="fa fa-phone"></i>
                                </div>
                                <input type="text" class="form-control" data-inputmask='"mask": "(+62) 9999-9999-9999"' data-mask name="nofax">
                              </div>
                          </div>
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-5">
                              <input type="text" class="form-control" placeholder="Nama" name="namaemail">
                            </div>
                            <div class="col-xs-5">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                                    <input type="email" class="form-control" placeholder="@gmail.com" name="endmail">
                                  </div>
                            </div>
                          </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="file_upload2">Upload thumb</label>
                        <input type="file" name="thumb" id = "image" accept=".jpg, .jpeg, .png" onchange="readURL1(this);" style="margin-bottom:60px;" >
                      <label for="file_upload2">Preview File</label>
                        <img id="blah1" src="image/400x400.jpg" alt="your image" /> 
                  </div>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Hak Cipta &copy; 2023 <a href="#">Bappeda DKI Jakarta</a>.</strong> All rights reserved.
  </footer>
