...
<head>
  ...
  <title>Admin-HomePengaturanWebsite</title>
      ...
      <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header" style="height: auto;">
              <h1>
                  Home
                  <small>Pengaturan Pada Website</small>
                </h1>
                        ...
                        <!--------------------------
                          ...
                          <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini 
                              ...
                              menu kontak di <a href="">website SDG's Jakarta</a>, Terima Kasih.</p> <ul class="sidebar-menu" data-widget="tree">
                                <li class="header" style="background-color: #f39d1223;"><h4>Input Kompenen Website</h4></li>
                                <!-- Optionally, you can add icons to the links -->
                                <li><a href="Admin-AturSlider.php"><i class="fa fa-link"></i> <span>Atur Slider</span></a></li>
                                <li><a href="Admin-AturFotoWebsite.php"><i class="fa fa-link"></i> <span>Atur Image</span></a></li>
                            </ul>
                        </div>
                      </section>
                  </div>
