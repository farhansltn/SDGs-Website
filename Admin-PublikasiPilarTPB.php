...
<head>
    ...
    <title>Admin-PublikasiPilarTPB</title>
          ...
          <section class="content-header" style="height: auto;">
              <h1>
                      ...
                      <section class="content container-fluid" >
                        <!--------------------------
                         ...
                         <div class="box">
                              ...
                              <a href="Admin-AturPilarTPB.php" style="font-size: larger; background-color: #ffb744;" class="btn btn-sm btn-info btn-flat pull-left">Update Dokumen</a>
                           </div>
                         </div>
                  ...
                  <tr>
                    ...
                    <td><a href="deletepilartpb.php?id=<?= $row["id"]; ?>" onclick="return confirm('Hapus Data?');"><button type="submit" class="btn btn-primary" style="background-color:red">Delete</button></a></td>
