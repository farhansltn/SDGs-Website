              ...
              <h1>
                ...
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                          ...
                          <form action="ScriptFileUploadSlider.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="box box-info">
                                  <div class="box-header">
                                    <h3 class="box-title">Headline
                                      <small>Slider TPB</small>
                                    </h3>
                                    <!-- tools box -->
                            ...
                            <div class="form-group">
                                <label for="file_upload">Upload Slider</label>
                                <input type="file" class="form-control-file" id="file_upload" name="slider" accept=".jpg, .jpeg, .png">
                            </div>
                            <div class="form-group">
                                <label for="name_input">Link</label>
