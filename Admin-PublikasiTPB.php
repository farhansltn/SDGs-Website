...
<head>
    ...
    <title>Admin-PublikasiInfoTPB</title>
                  ...
                  <section class="content container-fluid" >
                          <!--------------------------
                            ...
                            <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini 
                                ...
                                <a href="Admin-AturTPB.php" style="font-size: larger; background-color: #ffb744;" class="btn btn-sm btn-info btn-flat pull-left">Update Dokumen</a>
                            </div>
                            <div class="box">
                                <div class="box-header">
                                  <h3>Daftar Informasi Tujuan Pembangunan Berkelanjutan</h3>
                                </div> 
                                <!-- /.box-header -->
                                <div class="box-body">
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    <tbody style="text-align: center;">
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $row['namatpb']; ?></td>
                                          <td><?php echo $row['namapilar']; ?></td>
                                          <td><?php echo $row['link']; ?></td>
                                          <td><a href="DownloadFile.php?url=<?php echo $row['thumbnail']; ?>">Download</a></td>
                                          <td><?php echo strtoupper($row['ekstensi']) ?></td>
                                          <td><?php echo number_format($row['size']/(1024*1024), 2) ?>MB</td>
                                          <td><?php echo mb_strimwidth($row['editor1'],0,10); ?></td>	
                                          <td><a href="deletetpb.php?id=<?= $row["id"]; ?>" onclick="return confirm('Hapus Data?');"><button type="submit" class="btn btn-primary" style="background-color:red">Delete</button></a></td>
                                        </tr>
                                        <?php 
                                        }
                                        } 
