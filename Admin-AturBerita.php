...
<html>
  <head>
    ...
    <title>Admin-AturBeritaTPB</title>
              ...
              <h1>
                ...
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                            <!-- Optionally, you can add icons to the links -->
                           <h3><a href="">Buat Berita</a></h3>
                          <form action="ScriptFileUploadBerita.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            <label for="name_input">Judul Berita</label>
                            <input type="text" class="form-control" id="ipadd" name="judulberita" placeholder="Judul Headline Artikel">
                          </div>
                          <div class="form-group">
                            <label for="pilar">Pilih Pillar Berita</label>
                            <select class="form-control select2" data-placeholder="Pilih Pillar" name="pilar">
                      ...
                      <div class="form-group">
                          <label for="file_upload">Upload banner</label>
                      ...
                      <label for="file_upload2">Preview File</label>
                        <img id="blah" src="image/600x800.jpg" alt="your image" /> 
                      </div>
                      <div class="form-group"  style="width: 82.8%;">
                        <label for="jenkel">Kategori Berita</label>
                        <select class="form-control select2" data-placeholder="Pilih kategori artikel" name="kategoriberita">
                      ...
                      <div class="box box-info">
                        <div class="box-header">
                          <h3 class="box-title">Penjelasan
                            <small>Tentang Berita TPB</small>
                          </h3>
                          <!-- tools box -->
