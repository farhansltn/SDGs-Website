...
<html>
    <head>
        ...
        <title>Admin-AturKategoriStakeholder</title>
      ...
      <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header" style="height: auto;">
              <h1>
                  Daftar
                  <small>Kategori Stakeholder</small>
                </h1>
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                            <!-- Optionally, you can add icons to the links -->
                           <h3><a href="">DAFTAR</a></h3>
                           <form action="ScriptFileUploadKategoriStake.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              <label for="name_input">Kategori Pengunggah</label>
                              <input type="text" class="form-control" id="tpb" name="kategori" placeholder="KategoriStakeholder">
                          </div>
