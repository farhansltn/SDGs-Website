      ...
      <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header" style="height: auto;">
              <h1>
                  Profil
                  <small>Tujuan Pembangunan DKI Jakarta</small>
                </h1>
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                            <!-- Optionally, you can add icons to the links -->
                           <h3><a href="">Data Kontak</a></h3>
                          <form action="ScriptFileProfil.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <label for="name_input">Linkedin</label>
                                        <div class="input-group">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <label for="name_input">Instagram</label>
                                            <div class="input-group">
                                              <span class="input-group-addon"><i class="fa fa-instagram"></i></span>
                                              <input type="text" class="form-control" placeholder="@sdgsjakarta" name="instagram">
                                            </div> 
                                        </div>
                                        <div class="col-xs-6">
                                            <label for="name_input">Facebook</label>
                                            <div class="input-group">
                                              <span class="input-group-addon"><i class="fa fa-facebook"></i></span>
                                              <input type="text" class="form-control" placeholder="SDGs Jakarta" name="facebook">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="name_input">Nama TPB Jakarta</label>
                                    <input type="text" class="form-control" id="name_input" name="nama" placeholder="SDGs Jakarta">
                                </div>
                                <div class="form-group">
                                  <label for="name_input">Sekilas TPB Jakarta</label>
                                  <textarea class="form-control" rows="3" placeholder="Seklias..." name="sekilas"></textarea>
                                </div>
                                <div class="form-group">
                                  <label for="name_input">Alamat TPB</label>
                                  <textarea class="form-control" rows="3" placeholder="Jl..." name="alamat"></textarea>
                              </div>
                                <div class="form-group">
                                  <label for="namadepan">Nomor Telpon</label>
                                  <div class="input-group">
                                    <div class="input-group-addon">
                                      <i class="fa fa-phone"></i>
                                    </div>
                                    <input type="text" class="form-control" data-inputmask='"mask": "(+62) 9999-9999-9999"' data-mask name="notelp">
                                  </div>
                                  <div class="form-group">
                                    <label for="namadepan">Nomor Fax</label>
                                    <div class="input-group">
                                      <div class="input-group-addon">
                                        <i class="fa fa-phone"></i>
                                      </div>
                          ...
                          <button type="submit" class="btn btn-primary" style="margin-top: 20px ; background-color: #f39c12;">Submit</button>
                    </div>
              </section>
