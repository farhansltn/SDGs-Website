...
<head>
  ...
  <title>Admin-AturSubscriber</title>
              ...
              <h1>
                ...
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                            <!-- Optionally, you can add icons to the links -->
                           <h3><a href="">Registrasi Subscriber</a></h3>
                          <form action="ScriptFileUploadSubs.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              <label for="name_input">Nama Subscriber</label>
                              <input type="text" class="form-control" id="name_input" name="nama" placeholder="NAMA PANJANG">
                          </div>
                          <div class="form-group">
                            <label for="name_input">IP Subscriber</label>
                            <input type="text" class="form-control" id="ipadd" name="ipadd" placeholder="192.168.---.---">
                          </div>
                          <div class="form-group">
                            <label for="jenkel">Peran Subscriber</label>
