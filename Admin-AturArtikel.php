              ...
              <h1>
                ...
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                            <!-- Optionally, you can add icons to the links -->
                           <h3><a href="">Buat Artikel</a></h3>
                          <form action="ScriptFileUploadArtikel.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                              <label for="name_input">Email Pengunggah</label>
                              <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                                <input type="email" class="form-control" placeholder="@gmail.com" name="email">
                              </div></div>
                          <div class="form-group">
                              <label for="name_input">Nama Pengunggah</label>
                              <input type="text" class="form-control" id="name_input" name="nama" placeholder="Nama Pengunggah">
                          </div>
                          <div class="form-group">
                            <label for="name_input">Judul Artikel</label>
                            <input type="text" class="form-control" id="ipadd" name="judulartikel" placeholder="Judul Headline Artikel">
                          </div>
                          <div class="form-group">
                            <label for="peran">Pilih Pillar Artikel</label>
                            <select class="form-control select2" data-placeholder="Pilih Pillar" name="subjudul">
                              <option value="Sosial">Sosial</option>
                              <option value="Ekonomi">Ekonomi</option>
                              <option value="Lingkungan">Lingkungan</option>
                              <option value="Hukum dan Tata Kelola">Hukum dan Tata Kelola</option>
                            </select>
                          </div>
                        <div class="form-group">
                      ...
                      <div class="form-group">
                          <label for="file_upload2">Upload banner</label>
                          <input type="file" class="form-control-file" id="file_upload" name="banner" accept=".jpg, .jpeg, .png" onchange="readURL(this);" style="margin-bottom:60px;" >
                      <label for="file_upload2">Preview File</label>
                        <img id="blah" src="image/400x400.jpg" alt="your image" /> 
                      </div>
                      <div class="form-group"  style="width: 82.8%;">
                        <label for="jenkel">Kategori Artikel</label>
                        <select class="form-control select2" data-placeholder="Pilih kategori artikel" name="kategoriartikel">
                      ...
                      <div class="form-group">
                      <label for="name_input">Link Artikel</label>
                            <input type="text" class="form-control" id="ipadd" name="link" placeholder="Link Artikel">
