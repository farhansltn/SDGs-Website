...
<head>
  ...
  <title>Admin-PublikasiArtikel</title>
      ...
      <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header" style="height: auto;">
              <h1>
                  Publikasi
                  <small>Artikel Tujuan Pembangunan Berkelanjutan</small>
                </h1>
                      <section class="content container-fluid" >
                        <!--------------------------
                          ...
                          <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini 
                              ...
                              <a href="Admin-AturArtikel.php" style="font-size: larger; background-color: #ffb744;" class="btn btn-sm btn-info btn-flat pull-left">Update Dokumen</a>
                                       </div>
                          <div class="box">
                              <div class="box-header">
                                <h3>Daftar Artikel Tujuan Pembangunan Berkelanjutan</h3>
                              </div> 
                              <!-- /.box-header -->
                              <div class="box-body">
                              <table id="example1" class="table table-bordered table-hover">
                                      <thead style="background-color: #f39d12;color: #ffffff;">>
                                          <tr>
                                            ...
                                            <th>Thumbnail</th>
                                            <th>Ekstensi Thumbnail</th>
                                            <th>Size Thumbnail</th>
                                            <th>DeleteArticle</th>
                                          </tr>
                                          </thead>
									...
									?>
												<tr>
													...
													<td><?php echo $row['judulartikel']; ?></td>
													<td><?php echo $row['subjudul']; ?></td>
													<td><?php echo $row['kategoriartikel']; ?></td>
													<td><?php echo $row['titlethumb']; ?></td>
													<td><?php echo strtoupper($row['ekstensithumb']) ?></td>
													<td><?php echo number_format($row['sizethumb']/(1024*1024), 2) ?>MB</td>
												
                          <td><a href="deleteartikel.php?id=<?= $row["id"]; ?>" onclick="return confirm('Hapus Data?');"><button type="submit" class="btn btn-primary" style="background-color:red">Delete</button></a></td>
