...
<head>
  ...
  <title>Admin-AturInformasiTujuanPembangunanBerkelanjutan</title>
      ...
      <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header" style="height: auto;">
              <h1>
                  Daftar
                  <small>Informasi Tujuan Pembangunan Berkelanjutan</small>
                </h1>
                
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                            <!-- Optionally, you can add icons to the links -->
                           <h3><a href="">Input Informasi TPB</a></h3>
                          <form action="ScriptFileUploadTPB.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
                          <div class="form-group">
                              <label for="name_input">Nama TPB</label>
                              <input type="text" class="form-control" id="tpb" name="namatpb" placeholder="Nama Pengunggah">
                          </div>
                          <div class="form-group">
                            <label for="peran">Pilih Pillar Artikel</label>
                            <select class="form-control select2" data-placeholder="Pilih Pillar" name="namapilar">
                              <option value="Sosial">Sosial</option>
                              <option value="Ekonomi Pembangunan">Eknomoi Pembangunan</option>
                          ...
                          <div class="form-group">
                            <div class="box box-info">
                              <div class="box-header">
                                <h3 class="box-title">Indikator
                                  <small>Indikator TPB</small>
                                </h3>
                                <!-- tools box -->
                          ...
                          <div class="form-group">
                            <label for="file_upload">thumbnail</label>
                            <input type="file" class="form-control-file" id="thumbnail" name="thumbnail" accept=".jpg, .jpeg, .png" value="">
                        </div>
                        <div class="form-group">
                            <label for="file_upload">Banner</label>
                            <input type="file" class="form-control-file" id="banner" name="banner" accept=".jpg, .jpeg, .png" value="">
                        </div>
                        <div class="form-group">
                            <label for="file_upload">Banner Atas</label>
                            <input type="file" class="form-control-file" id="banneratas" name="banneratas" accept=".jpg, .jpeg, .png" value="">
                        </div>
                    <div class="form-group">
                      <div class="box box-info">
                        <div class="box-header">
                          <h3 class="box-title">Penjelasan
                            <small>Tentang TPB</small>
                          </h3>
                          <!-- tools box -->
                          <div class="pull-right box-tools">
                            <button type="button" class="btn btn-info btn-sm" data-widget="collapse" data-toggle="tooltip"
                      ...
                      <div class="box box-info">
                        <div class="box-header">
                          <h3 class="box-title">Deskripsi
                            <small>Tujuan Pembangunan Berkelanjutan</small>
                          </h3>
                          <!-- tools box -->
                          <div class="pull-right box-tools">
                            <button type="button" class="btn btn-info btn-sm" data-widget="collapse" data-toggle="tooltip"
