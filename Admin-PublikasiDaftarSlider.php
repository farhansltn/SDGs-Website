...
<head>
  ...
  <title>Admin-PublikasiSlider</title>
          ...
          <section class="content-header" style="height: auto;">
              <h1>
                ...
                <section style="padding: 20px;">  
                      <section class="content container-fluid" style="border-color: #f39d12;">
                      <div class="box box-primary" style="padding : 20px;border-color: #f39d12;height: 140px;">
                      <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini 
                              ...
                              <a href="Admin-AturSlider.php" style="font-size: larger; background-color: #ffb744;" class="btn btn-sm btn-info btn-flat pull-left">Update Dokumen</a>
                             </div>
                        <!--------------------------
                              ...
                              <table id="example1" class="table table-bordered table-hover">
                                  <thead style="background-color: #f39d12;color: #ffffff;">
                                          ...
                                          <th>No</th>
                                            ...
                                            <th>Ekstensi Slider</th>
                                            <th>Ukuran Slider</th>
                                            <th>Download Slider</th>
                                            <th>Headline Slider</th>
                                            <th>Tentang Slider</th>
                                            <th>Delete Slider</th>
                                          </tr>
                                          </thead>
									...
									?>
												<tr>
													...
													<td><?php echo $row['linkslider']; ?></td>
													<td><?php echo strtoupper($row['ekstensislider']) ?></td>
													<td><?php echo number_format($row['sizeslider']/(1024*1024), 2) ?>MB</td>
													<td><a href="DownloadFile.php?url=<?php echo $row['slider']; ?>">Download</a></td>
													<td><?php echo substr($row['editor1'],0,70); ?>...</td>
													<td><?php echo substr($row['editor2'],0,70); ?>...</td>
                          <td><a href="deleteslider.php?id=<?= $row["id"]; ?>" onclick="return confirm('Hapus Slider?');"><button type="submit" class="btn btn-primary" style="background-color:red">Delete</button></a></td>
