                        ...
                        <!--------------------------
                          ...
                          <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini 
                              ...
                              <ul class="sidebar-menu" data-widget="tree">
                                ...
                                <!-- Optionally, you can add icons to the links -->
                                <li><a href="Admin-AturTPB.php"><i class="fa fa-link"></i> <span>Daftar TPB</span></a></li>
                                <li><a href="Admin-AturPilarTPB.php"><i class="fa fa-link"></i> <span>Daftar Pilar TBP</span></a></li>
                            </ul>
                        </div>
                      </section>
                  </div>
