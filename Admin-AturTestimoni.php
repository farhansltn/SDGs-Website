...
<html>
    <head>
        ...
        <title>Admin-AturTestimoni</title>
      ...
      <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header" style="height: auto;">
              <h1>
                  Daftar
                  <small>Testimoni User</small>
                </h1>
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                            <!-- Optionally, you can add icons to the links -->
                           <h3><a href="">Testimoni User</a></h3>
                           <form action="ScriptFileUploadTestimoni.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
                          <div class="form-group">
                              <label for="name_input">Nama User</label>
                              <input type="text" class="form-control" id="tpb" name="nama" placeholder="Nama Pengunggah">
                          </div>
                          <div class="form-group">
                              <label for="name_input">Email User</label>
                              <input type="text" class="form-control" id="tpb" name="email" placeholder="Email Pengunggah">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="peran">Pilih Penilaian</label>
                            <select class="form-control select2" data-placeholder="Pilih Sektor Penilaian" name="penilaian">
                              <option value="UI/UX">UI/UX</option>
                              <option value="Aksesibilitas">Aksesibilitas</option>
                              <option value="Dekorasi">Dekorasi</option>
                              <option value="Kelengkapan Data">Kelengkapan Data</option>
                            </select>
                          </div>
                          <div class="form-group">
                            <label for="peran">Penilaian</label>
                            <select class="form-control select2" data-placeholder="Pilih Nilai (/5)" name="nilai">
                          ...
                          <div class="form-group">
                            <div class="box box-info">
                              <div class="box-header">
                                <h3 class="box-title">Testimoni/Saran
