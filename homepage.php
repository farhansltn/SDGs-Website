    ...
    <div class="wrapper">
                ...
                <li class="dropdown user user-menu">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="user-footer">
                      <div class="pull-left">
                        <a href="http://localhost/webdev/signup.php" class="btn btn-default btn-flat">Register</a>
                      </div>
          ...
          <section class="sidebar" style="text-decoration-color: #f39c12;"> 
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="Admin-PublikasiKategoriStake.php">Publikasi Kategori Pemangku Kepentingan</a></li>
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header" style="height: auto;">
              <h1>
                  Publikasi
                  <small>Laporan Tenaga Ahli</small>
                </h1>
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                        <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini untuk registrasi data yang ingin anda masukan ke dalam database. Untuk mengubah data, silahkan hubungi admin utama pada menu kontak di <a href="#">Website SDG's Jakarta</a>, Terima Kasih.</p>
                          <ul class="sidebar-menu" data-widget="tree">
                            <li class="header" style="background-color: #f39d1221;
                            "><h4>Daftar Menjadi Admin</h4></li>
                            <!-- Optionally, you can add icons to the links -->
                            <li><a href="../../signup.php"><i class="fa fa-link"></i> <span>Registrasi User</span></a></li>
                          </ul>
                    </div>
                  ...
                  style="border-color: #f39c12;">
                    ...
                    $result = mysqli_query(koneksiDB(), $query);
                          ...
                          <td><a href="deleteuser.php?id=<?= $row["idUsers"]; ?>" onclick="return confirm('Hapus Data?');"><button type="submit" class="btn btn-primary" style="background-color:red">Delete</button></a></td>
													</tr>
									<?php 
											}
										} 
