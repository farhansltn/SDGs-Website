...
<head>
  ...
  <title>Admin-HomePublikasi</title>
                      ...
                      <section class="content container-fluid">
                        <!--------------------------
                          ...
                          <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini 
                              ...
                              <ul class="sidebar-menu" data-widget="tree">
                                <li class="header" style="background-color: #f39d1223;"><h4>Update Galeri TPB</h4></li>
                                <!-- Optionally, you can add icons to the links -->
                                <li><a href="Admin-UnggahFoto.php"><i class="fa fa-link"></i> <span>Galeri Foto</span></a></li>
                                <li><a href="Admin-UnggahVideo.php"><i class="fa fa-link"></i> <span>Galeri Video</span></a></li>
                                <li><a href="Admin-DaftarDokumen.php"><i class="fa fa-link"></i> <span>Dokumen TPB</span></a></li>
                                <li><a href="Admin-AturData.php"><i class="fa fa-link"></i> <span>Data TPB</span></a></li>  
                            </ul>
                        </div>
                      </section>
                  </div>
