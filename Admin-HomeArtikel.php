...
<head>
  ...
  <title>Admin-HalamanUtamaArtikel</title>
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="../../signup.phpp" class="btn btn-default btn-flat">Register</a>
                  </div>
                        ...
                        <!--------------------------
                          ...
                          <div class="box box-primary" style="padding: 20px;border-color: #f39d12;">
                            ...
                            <ul class="sidebar-menu" data-widget="tree">
                                ...
                                <!-- Optionally, you can add icons to the links -->
                                <li><a href="Admin-AturArtikel.php"><i class="fa fa-link"></i> <span>Daftar Artikel</span></a></li>
                                <li><a href="Admin-AturBerita.php"><i class="fa fa-link"></i> <span>Daftar Berita</span></a></li>
                            </ul>
                        </div>
                      </section>
                  </div>
