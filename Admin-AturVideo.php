...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header" style="height: auto;">
        <h1>
            Daftar
            <small>Daftar Video</small>
          </h1>
          <section style="padding: 60px;">  
            <div class="box box-primary" style="border-color:#f39d12;">
              <div class="box-header with-border">
                <form action="ScriptFileUploadVid.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="title_file" name="namavideo" rows="3"></textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="title_file" name="linkvideo" rows="3"></textarea>
                    </div>
