...
<head>
  ...
  <title>Admin-LaporanHarian</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
              ...
              <h1>
                ...
                <section style="padding: 20px;">  
                    <div class="box box-primary" style="padding: 20px;border-color: #f39c12;">
                            <!-- Optionally, you can add icons to the links -->
                           <h3><a href="">Atur Laporan</a></h3>
                           <form action="ScriptFileUpload3.php" id="myform" name="myform" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <textarea class="form-control" id="title_file" name="namabuku" rows="3"></textarea>
          </div>
          <div class="form-group">
