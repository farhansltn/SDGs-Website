                        ...
                        <!--------------------------
                          ...
                          <div class="box box-primary" style="padding : 20px;border-color: #f39d12;height: 140px;">
                           <p>Halaman Ini Merupakan Halaman Publikasi. Anda akan melihat tampilan data-data yang sudah anda . masukan. Jika anda belum melihat data anda, silahkan klik tombol dibawah ini 
                              ...
                              <a href="Admin-AturProfil.php" style="font-size: larger; background-color: #ffb744;" class="btn btn-sm btn-info btn-flat pull-left">Update Dokumen</a>
                           </div>
                        <!--------------------------
                          | Your Page Content Here |
                          -------------------------->
                                  ...
                                  <thead style="background-color: #f39d12;color: #ffffff;">
									...
									?>
												<tr>
													...
													<td><?php echo substr($row['sekilas'],0,70); ?>...</td>
													<td><?php echo substr($row['alamat'],0,70); ?>...</td>
													<td><?php echo $row['email']; ?></td>
													<td><?php echo $row['linkedin']; ?></td>
													<td><?php echo $row['notelp']; ?></td>
                          <td><a href="deleteprofil.php?id=<?= $row["id"]; ?>" onclick="return confirm('Hapus Data?');"><button type="submit" class="btn btn-primary" style="background-color:red">Delete</button></a></td>
